...
<head>
    ...
    <link rel="stylesheet" href="/student/css/login.css?v=<?php echo $loginCssVersion; ?>">
</head>
<body>
            ...
            <div class="login-card">
                ...
                <div class="login-links">
                    <div>
                        ...
                        <a href="/student/register.php" data-i18n="login.register">Register</a>
                    </div>
                    <div>
                        <a href="/student/forgot_password.php" data-i18n="login.forgot_password">Forgot password?</a>
                    </div>
                </div>
            </div>
        </div>
