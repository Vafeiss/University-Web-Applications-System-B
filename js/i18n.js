...
(function () {
    ...
    const translations = {
        en: {
            ...
            "notifications.post_deleted_by_admin": "An admin deleted your post \"{title}\"",
        ...
        el: {
            ...
            "notifications.post_deleted_by_admin": "Ο διαχειριστής διέγραψε την ανάρτησή σας «{title}»",
            ...
            "admin.manage_ads": "Διαχείριση διαφημίσεων",
