...
async function loadPost(postId){
    ...
    const response = await fetch(
        "/student/backend/controllers/PostController.php?action=get&id=" + postId
    );
...
function renderAttachments(attachments){
        ...
        attachments.forEach(file => {
            ...
            const fileUrl = Number.isInteger(attachmentId) && attachmentId > 0
                ? `/student/backend/controllers/PostController.php?action=downloadAttachment&attachment_id=${attachmentId}`
...
async function loadComments(postId, options = {}){
    ...
    const response = await fetch(
        "/student/backend/controllers/CommentController.php?action=list&post_id=" + postId
    );
    initCommentComposer();
...
async function previewAttachmentDownload(trigger) {
    ...
    try {
        const response = await fetch(
            `/student/backend/controllers/PostController.php?action=previewDownload&attachment_id=${attachmentId}`,
            { cache: "no-store" }
        );
...
document.addEventListener("submit", async function(e){
    ...
    await fetch(
        "/student/backend/controllers/CommentController.php?action=create",
        {
            method:"POST",
            headers:{
...
document.addEventListener("submit", async function (event) {
    ...
    try {
        ...
        const response = await fetch(
            "/student/backend/controllers/CommentController.php?action=requestDelete",
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
...
document.addEventListener("click", async function (event) {
    ...
    try {
        const response = await fetch(
            "/student/backend/controllers/CommentController.php?action=adminDelete",
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
...
document.addEventListener("click", async function(event){
    ...
    try {
        const response = await fetch(
            "/student/backend/controllers/PostController.php?action=adminDelete",
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
...
document.addEventListener("submit", async function(event){
    ...
    try {
        const response = await fetch(
            "/student/backend/controllers/PostController.php?action=requestDelete",
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
...
document.addEventListener("submit", async function(event){
    ...
    try {
        const response = await fetch(
            "/student/backend/controllers/PostController.php?action=requestReport",
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
