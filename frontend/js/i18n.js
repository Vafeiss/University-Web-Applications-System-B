(function () {
    ...
    const translations = {
        ...
        el: {
            ...
            "posts.create_post": "Δημιουργία ανάρτησης",
            "posts.posts": "Αναρτήσεις",
            "posts.followers": "Ακόλουθοι",
            "posts.pending_posts": "Εκκρεμείς αναρτήσεις",
            "posts.pending_delete_requests": "Εκκρεμή αιτήματα διαγραφής",
            "posts.reports": "Αναφορές",
            "posts.token_history": "Ιστορικό token",
            "posts.posts_feed": "Ροή αναρτήσεων",
            ...
            "posts.create_post_heading": "Δημιουργία νέας ανάρτησης",
            ...
            "posts.token_history_heading": "Ιστορικό token",
