...
require_once __DIR__ . "/backend/middleware/ProfileGuard.php";
...
<link rel="stylesheet" href="/student/css/index.css?v=<?php echo $indexCssVersion; ?>">
...
<div class="d-flex justify-content-end align-items-center gap-2 pt-4 pe-4 dashboard-top-menu">
     <a href="/student/profile_view.php" class="btn btn-link">View &amp; Edit profile</a>
     <a href="/student/edit_interests.php" class="btn btn-link">Edit interests</a>
     <a href="/student/category_request.php" class="btn btn-link">Request category</a>
     <a href="/student/ads_user.php" class="btn btn-warning fw-bold">Watch Ads</a>
